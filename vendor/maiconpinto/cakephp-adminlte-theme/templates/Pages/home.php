  ...
  <div class="row">
    <div class="col-lg-3 col-xs-6">
      ...
      <div class="small-box bg-aqua">
        ...
        <a href="<?php echo $this->Url->build('/usuarios'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
    ...
    <div class="col-lg-3 col-xs-6">
      ...
      <div class="small-box bg-green">
        <div class="inner">
          <h3><?php echo $num_rows_produtos ?><sup style="font-size: 20px"></sup></h3>
        ...
        <a href="<?php echo $this->Url->build('/produtos'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- ./col -->
    <div class="col-lg-3 col-xs-6">
      ...
      <div class="small-box bg-yellow">
        <div class="inner">
          <h3><?php echo $num_rows_catprod ?></h3>
        ...
        <a href="<?php echo $this->Url->build('/CategoriasProdutos'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- ./col -->
