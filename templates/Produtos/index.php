            ...
            <tbody>
              <?php foreach ($produtos as $produto): ?>
                <tr>
                  ...
                  <td><?= h($produto->categorias_produto_id) ?></td>
                  <td><?= h($produto->created) ?></td>
                  <td><?= h($produto->modified) ?></td>
                  <td class="actions text-right">
                      <?= $this->Html->link(__('View'), ['action' => 'view', $produto->id], ['class'=>'btn btn-info btn-xs']) ?>
                      <?= $this->Html->link(__('Edit'), ['action' => 'edit', $produto->id], ['class'=>'btn btn-warning btn-xs']) ?>
